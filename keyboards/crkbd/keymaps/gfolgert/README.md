...
**Mouse Buttons** are placed on the bottom row near the trackball, emulating the feel of a mouse. **Scroll Up** and **Scroll Down** chords are one key position away from Page Up/Down, making for an easy switch between fast or slow page navigation. **Scroll Left** and **Scroll Right** physically rotate your hand to face the direction you want to be scrolling. The Scroll Left chord could trigger with words like “e-L-M.”
